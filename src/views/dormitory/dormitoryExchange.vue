<template>
  <div class="wrap" id="wrap">
    <div class='list'>
      <ul>
				<li>
          <div style="margin: auto;">换窗前床铺信息</div>
        </li>
        <li>
        ...
        <li>
          <div class='title'>床铺号码</div>
          <div class='content'></div>
        </li>
        <li>
          <div class='title'>房间级别</div>
          <div class='content'></div>
        </li>
        <li>
        ...
        <li>
          ...
          <div class='content'></div>
			...
			<ul>
				<li>
          <div style="margin: auto;">换窗后床铺信息</div>
        </li>
        <li>
          <div class='title'>组织</div>
          <div class='content'></div>
        ...
        <li>
          <div class='title'>换床类型</div>
          <div class='content'></div>
        </li>
				<li>
          <div class='title'>新床铺号</div>
          <div class='content'></div>
        </li>
        <li>
          <div class='title'>房间级别</div>

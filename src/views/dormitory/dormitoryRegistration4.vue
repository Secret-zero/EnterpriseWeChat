      ...
      <ul>
        ...
        <li>
          ...
          <div class='content'></div>
				...
				<li>
          <div class='title'>床铺ID</div>
          <div class='content'>{{FitemID}}</div>
        </li>
        <li>
          <div class='title'>工号ID</div>
          <div class='content'>{{FEmpNumber}}</div>
        </li>
        <li>
          <div class='title'>姓名</div>
          <div class='content'></div>
...
<script>
import { JDGetAssestByFInterID, JDSubmitSsDormitory, upLoadImg } from '@/api/getData'
  ...
  mounted() {
    ...
    async upLoadImg() {
      ...
      let Json = {
        ...
        FEmpID: this.FEmpID,
				FEmpName: this.FEmpName,
				FSpouseEmpID:this.FSpouseEmpID,
				Fdate:this.Fdate,
				FHobby:this.FHobby,
				FNote:this.FNote
			}
